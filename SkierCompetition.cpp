...
//11/17/17
//Skiers Competition
//This program determines the fastest skier, by averaging their speeds 
...
using namespace std;
//functions
double FastSkier(double[], string[], int);     //fastest 
double AvgTime(double[], int);                  //finds Average
int SpecTime(double[], string[], int);          //finds the time of the name entered
